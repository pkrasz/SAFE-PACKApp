...
final class BasketView: BaseView {
    ...
    override func setupConstraints() {
        NSLayoutConstraint.activate([
            ...
            infoBackground.widthAnchor.constraint(equalToConstant: OrderView.Background.height),
            infoBackground.heightAnchor.constraint(equalToConstant: OrderView.Background.width),
            ...
            deliveryAddressLabel.trailingAnchor.constraint(lessThanOrEqualTo: infoBackground.trailingAnchor, constant: OrderView.Line.topSpace),
            
            lineImage.topAnchor.constraint(equalTo: deliveryAddressLabel.bottomAnchor, constant: OrderView.Line.topSpace),
            ...
            completeOrderButton.topAnchor.constraint(equalTo: infoBackground.bottomAnchor, constant: OrderView.Button.topSpace),

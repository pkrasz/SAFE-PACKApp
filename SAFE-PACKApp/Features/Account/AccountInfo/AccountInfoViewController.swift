...
final class AccountInfoViewController: BaseViewController<AccountInfoView> {
    ...
    override func setupView() {
        ...
        if newUser == true {
            ...
            showAlert(
                title: Alert.Title.completeTheRegostration,
                message: Alert.Messege.fillTheData,
                actions: [Alert.Action.continue]
            )
        } else {
